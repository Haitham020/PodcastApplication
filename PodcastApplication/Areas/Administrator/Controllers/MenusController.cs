...
namespace PodcastApplication.Areas.Administrator.Controllers
{
    ...
    public class MenusController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MenuId,MenuTitle,ActionUrl,ControllerUrl,ParentMenuId")] Menu menu)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MenuId,MenuTitle,ActionUrl,ControllerUrl,ParentMenuId")] Menu menu)
        {
            if (id != menu.MenuId)
            {
                return NotFound();
